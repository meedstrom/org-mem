...
(defsubst indexed-lnum (any)             "ANY." (aref any 0))
(defsubst indexed-pos (any)              "ANY." (aref any 1))
...
(defsubst indexed-deadline (entry)       "ENTRY." (aref entry 12))
(defsubst indexed-priority (entry)       "ENTRY." (aref entry 13))
