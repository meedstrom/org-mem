...
UPDATE [2025-03-20]: you can now use =org-roam-db-query=!
...
The above is only relevant if you do use org-roam.  I'd advise developers to drop the dependency and require only EmacSQL, since this is the same:
