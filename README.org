...
Pick the former, it's usually not important.  The former cancels on ~C-g~, the latter continues the update in the background even after ~C-g~.
...
*** Full list of functions [2026-02-07]
