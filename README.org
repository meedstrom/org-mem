...
#+TITLE: Indexed
#+HTML: <a href="https://repology.org/project/emacs%3Aindexed/versions"> <img src="https://repology.org/badge/vertical-allrepos/emacs%3Aindexed.svg" alt="Packaging status" align="right"> </a>
...
Loaded by =indexed-roam-mode=.  Explained elsewhere.
...
That's very good, because if you had clicked an ID-link that org-id did not know about, it would react by running =org-id-update-id-locations=, making Emacs appear to hang for a long time.
