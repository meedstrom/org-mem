...
Builds very fast.  Numbers from my =M-x indexed-reset=:

#+begin_example
indexed: Analyzed 160616 lines in 10734 entries (3397 with ID) in 2394 files in 1.37s + 0.16s to build SQLite DB
#+end_example
...
For the elisp, see [[https://github.com/meedstrom/indexed?tab=readme-ov-file#appendix-i-api][Appendix I]].
...
NOTE: Namespace *still under flux!*  This *may be out of date!*
