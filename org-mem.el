...
(defconst org-mem-internal-version 29 "Not a version number, but bumped sometimes.")
...
(cl-defstruct org-mem-entry
  ...
  (pseudo-id             -1  :read-only t :type integer        :documentation "Generated by `org-mem-parser--mk-id'.  Not `eq'-safe, so use `=', `eql' or `equal'."))
